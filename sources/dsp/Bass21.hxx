 ...
 public:
	...
	void compute(int count, FAUSTFLOAT const* const* inputs, FAUSTFLOAT* const* outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp5 = (fTemp0 * fRec16[0]);
			fVec0[0] = fTemp5;
			fVec1[0] = ((fConst23 * fVec0[1]) - (fConst24 * fRec14[1]));
			fRec15[0] = (fVec1[1] + (fConst25 * ((fConst26 * fTemp5) - (2.0f * fRec15[1]))));
			fRec14[0] = fRec15[0];
			fRec13[0] = (fRec14[0] - (fConst19 * (((fConst31 * fRec13[1]) + (fConst33 * fRec13[2])) + (fConst36 * fRec13[3]))));
			float fTemp6 = ((((fConst20 * fRec13[0]) + (fConst38 * fRec13[1])) + (fConst39 * fRec13[2])) + (fConst40 * fRec13[3]));
			fRec17[0] = (fSlow2 + (fConst7 * fRec17[1]));
			float fTemp7 = ((100000.0f * (1.0f - fRec17[0])) + 3300.0f);
			...
			fVec3[0] = ((fConst19 * fVec2[1]) - ((fRec11[1] * ((fConst0 * (fTemp8 - fTemp11)) + 1.0f)) / fTemp12));
			float fTemp13 = ((fConst43 * fTemp7) + 2.0f);
			fVec4[0] = ((fTemp13 * fTemp6) / fTemp12);
			fRec12[0] = ((fVec3[1] + (fConst19 * fVec4[1])) - (((fRec12[1] * fTemp13) - (fConst19 * (fTemp6 * ((fConst0 * (fTemp8 + fTemp10)) + 1.0f)))) / fTemp12));
			fRec11[0] = fRec12[0];
			float fTemp14 = std::max<float>(-1.0f, std::min<float>(1.0f, fRec11[0]));
			float fTemp15 = (fTemp14 * (1.0f - (0.333333343f * Bass21_faustpower2_f(fTemp14))));
			fRec18[0] = (fSlow3 + (fConst7 * fRec18[1]));
			float fTemp16 = (100000.0f * (1.0f - fRec18[0]));
			float fTemp17 = (fTemp16 + 3300.0f);
			float fTemp18 = (fConst44 * fTemp17);
			float fTemp19 = (fTemp16 + fTemp18);
			float fTemp20 = (fTemp19 + 3300.0f);
			fVec5[0] = ((fTemp15 * (fTemp16 + (333300.0f - fTemp18))) / fTemp20);
			fVec6[0] = (fVec5[1] - ((fRec9[1] * (fTemp16 + (3300.0f - fTemp18))) / fTemp20));
			fVec7[0] = ((fTemp15 * (fTemp16 + 333300.0f)) / fTemp20);
			fRec10[0] = ((fVec6[1] + ((fTemp15 * (fTemp19 + 333300.0f)) / fTemp20)) - (2.0f * (((fRec10[1] * fTemp17) / fTemp20) - fVec7[1])));
			fRec9[0] = fRec10[0];
			float fTemp21 = std::max<float>(-1.0f, std::min<float>(1.0f, fRec9[0]));
			fRec8[0] = ((fTemp21 * (1.0f - (0.333333343f * Bass21_faustpower2_f(fTemp21)))) - (fConst45 * (((fConst47 * fRec8[1]) + (fConst48 * fRec8[2])) + (fConst49 * fRec8[3]))));
			float fTemp22 = ((((fConst17 * fRec8[0]) + (fConst50 * fRec8[1])) + (fConst51 * fRec8[2])) + (fConst52 * fRec8[3]));
			fVec8[0] = fTemp22;
			fVec9[0] = (0.0f - (fConst12 * ((fConst13 * fRec6[1]) - (fConst15 * fVec8[1]))));
			fRec7[0] = (fVec9[1] - (fConst12 * ((fConst53 * (fRec7[1] - (fConst45 * fVec8[1]))) - (fConst54 * fTemp22))));
			fRec6[0] = fRec7[0];
			...
			fRec20[0] = (fSlow5 + (fConst7 * fRec20[1]));
			float fTemp23 = std::max<float>(-1.0f, std::min<float>(1.0f, (0.0f - (2.20000005f * (((fRec4[0] * fRec19[0]) + (fRec14[0] * (1.0f - fRec19[0]))) * fRec20[0])))));
			float fTemp24 = (fTemp23 * (1.0f - (0.333333343f * Bass21_faustpower2_f(fTemp23))));
			fVec11[0] = fTemp24;
			float fTemp25 = (fTemp3 + 1.0f);
			fRec2[0] = (0.0f - (((fTemp4 * fRec2[1]) - (fTemp24 + fVec11[1])) / fTemp25));
			fRec21[0] = ((fVec11[1] * (0.0f - (1.0f / (fTemp2 * fTemp25)))) - (((fRec21[1] * fTemp4) - (fTemp24 / fTemp2)) / fTemp25));
			fRec22[0] = (fSlow6 + (fConst7 * fRec22[1]));
			float fTemp26 = ((24.0f * fRec22[0]) + -18.0f);
			int iTemp27 = (fTemp26 > 0.0f);
			float fTemp28 = (fConst57 * std::pow(10.0f, (0.0500000007f * std::fabs(fTemp26))));
			float fTemp29 = (iTemp27 ? fConst57 : fTemp28);
			float fTemp30 = (fConst5 * fRec1[1]);
			float fTemp31 = ((fConst56 * (fConst56 + fTemp29)) + 1.0f);
			fRec1[0] = ((fRec2[0] + (fRec21[0] * std::pow(10.0f, (0.0500000007f * fTemp1)))) - (((fRec1[2] * ((fConst56 * (fConst56 - fTemp29)) + 1.0f)) + fTemp30) / fTemp31));
			float fTemp32 = (iTemp27 ? fTemp28 : fConst57);
			float fTemp33 = ((6.0f * fRec22[0]) + -18.0f);
			int iTemp34 = (fTemp33 > 0.0f);
			float fTemp35 = (fConst59 * std::pow(10.0f, (0.0500000007f * std::fabs(fTemp33))));
			float fTemp36 = (iTemp34 ? fConst59 : fTemp35);
			float fTemp37 = (fConst3 * fRec0[1]);
			float fTemp38 = ((fConst58 * (fConst58 + fTemp36)) + 1.0f);
			fRec0[0] = ((((fTemp30 + (fRec1[0] * ((fConst56 * (fConst56 + fTemp32)) + 1.0f))) + (fRec1[2] * ((fConst56 * (fConst56 - fTemp32)) + 1.0f))) / fTemp31) - (((fRec0[2] * ((fConst58 * (fConst58 - fTemp36)) + 1.0f)) + fTemp37) / fTemp38));
			float fTemp39 = (iTemp34 ? fTemp35 : fConst59);
			float fTemp40 = std::max<float>(-1.0f, std::min<float>(1.0f, (((fTemp37 + (fRec0[0] * ((fConst58 * (fConst58 + fTemp39)) + 1.0f))) + (fRec0[2] * ((fConst58 * (fConst58 - fTemp39)) + 1.0f))) / fTemp38)));
			output0[i0] = FAUSTFLOAT((fTemp40 * (1.0f - (0.333333343f * Bass21_faustpower2_f(fTemp40)))));
			fRec3[1] = fRec3[0];
			fRec16[1] = fRec16[0];
			fVec0[1] = fVec0[0];
			fVec1[1] = fVec1[0];
